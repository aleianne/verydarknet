...
// http://clmathlibraries.github.io/clBLAS/group__GEMM.html#ga29d93e46c106ce34249f21e436ed7102
// for a deep understanding of the gemm parameters
        ...
        float *C, int ldc)
{
    ...
    // this loop initialize the output tensor
    for(i = 0; i < M; ++i){
        for(j = 0; j < N; ++j){
            C[i*ldc + j] *= BETA;
        }
