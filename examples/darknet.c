...
extern void predict_classifier(char *datacfg, char *cfgfile, char *weightfile, char *filename, int top, char *fault_model_value, int fault_percentage,  char *testfile, int network_layer);
...
// this function take the configuration and weights file passed as second and third argument
// the value n is the number of the layer
